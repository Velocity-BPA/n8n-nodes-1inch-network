...
## Project Context
This is an n8n community node package for **1inch Network** published to npm and the n8n marketplace. It follows the n8n-nodes-starter template structure with TypeScript, credentials, and node definitions.
...
npm link
cd ~/.n8n/custom
npm link n8n-nodes-1inchnetwork
```
